        ...
        <div id="myTabContent" class="tab-content">
          ...
          <div role="tabpanel" class="tab-pane fade in active" id="budget" aria-labelledby="home-tab">
            ...
            <div class="row">
              ...
              // $totalBudget = 0;
              // $namaUser = $d['pengaju'];
              // $getPengajuanDataSelesai = mysqli_query($koneksi, "SELECT total,status FROM selesai WHERE pengaju='$namaUser'");
              // foreach ($getPengajuanDataSelesai as $data) {
              //   if ($data['status'] != 'UM Burek') $totalBudget += $data['total'];
              // }
              ?>
