...
$year = $_POST['year'];
?>
<div id="honor" class="tab-pane fade in active">
    ...
    <table class=" table table-striped table-bordered">
        ...
        <tbody>
            <?php
            $i = 1;
            $carihonor = mysqli_query($koneksi, "SELECT * FROM selesai WHERE rincian LIKE '%honor%' AND waktu IN (SELECT waktu FROM pengajuan WHERE jenis='B1' AND status='Disetujui' AND tahun = '$year')");
