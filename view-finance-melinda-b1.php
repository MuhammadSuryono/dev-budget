  ...
  <div class="container">
    ...
    <div class="but_list">
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <?php
                          if ($a['status'] == 'Honor Eksternal' || $a['status'] == 'Biaya') {
                          ?>
                            <button type="button" class="btn btn-default btn-small" onclick="edit_budget('<?php echo $no; ?>','<?php echo $waktu; ?>')">BPU</button>
                            <br><br>
                            <button type="button" class="btn btn-default btn-small" onclick="bayar_budget('<?php echo $no; ?>','<?php echo $waktu; ?>')">Bayar</button>
                          <?php
                          } else {
                          ?>
                            <button type="button" class="btn btn-default btn-small" onclick="bayar_budget('<?php echo $no; ?>','<?php echo $waktu; ?>')">Bayar</button>
      ...
      <script type="text/javascript">
        ...
        function bayar_budget(no, waktu) {
          // alert(noid+' - '+waktu);
          $.ajax({
            type: 'post',
            url: 'bayarbudget.php',
