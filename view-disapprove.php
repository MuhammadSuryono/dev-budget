    ...
    <div class="but_list">
      <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
        ...
        <div id="myTabContent" class="tab-content">
          ...
          <div role="tabpanel" class="tab-pane fade in active" id="budget" aria-labelledby="home-tab">
                  ...
                  <tbody>
                    ...
                    ?>
                        ...
                        <tr>
                          ...
                          ?>
                            <button type="button" class="btn btn-default btn-small" onclick="edit_budget('<?php echo $no; ?>','<?php echo $waktu; ?>')">Edit</button>
                          <?php
                          } else {
                            echo "<button type='button' class='btn btn-default btn-small' data-toggle='modal' data-target='#myModal4'>Edit</button>";
                          }
                          ?>
                        </td> -->
                          <td> <button type="button" class="btn btn-default btn-small buttonEdit" onclick="edit_budget('<?php echo $no; ?>','<?php echo $waktu; ?>')">Edit</button></td>
            ...
            <button type="button" class="btn btn-success btn-small pull-right" style="margin-left: 5px;" id="buttonAjukan" data-toggle="modal" data-target="#requestModal" data-id="<?= $code ?>">Ajukan</button>
            <!-- <input type="button" class="btn btn-primary pull-right" id="submitButton" style="margin-left: 5px;" data-toggle="modal" value="Simpan" /> -->
            <button type="button" id="buttonTambah" class="btn btn-default btn-small pull-right" onclick="tambah_budget('<?php echo $waktu; ?>','<?php echo $code; ?>')">Tambah</button>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-center">Edit Budget</h4>
            </div>
      ...
      <div class="modal fade" id="myModal3" role="dialog">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
              <h4 class="modal-title text-center">UPLOAD File</h4>
            </div>
            <div class="modal-body">
              <div class="fetched-data"></div>
            </div>
      ...
      <div class="modal fade" id="myModal2" role="dialog">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
              <h4 class="modal-title text-center">Tambah Budget</h4>
            </div>
            <div class="modal-body">
      ...
      <div class="modal fade" id="myModal4" role="dialog">
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
              <h4 class="modal-title text-center">Edit dan Tambah Budget</h4>
            </div>
            <div class="modal-body">
              <p>Untuk <b>penambahan atau edit Budget Disapprove</b>, harap upload File terkait perubahan budget terlebih dahulu.</p>
            </div>
            <div class="modal-footer">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group" style="margin-top: 2px;">
                <input type="text" id="keteranganTambahan" class="form-control" id="exampleInputEmail1" placeholder="Keterangan">
              </div>
            </div>
            <div class="modal-footer">
      ...
      <script type="text/javascript">
        $(document).ready(function() {
          let arrStatus1 = ['Honor Jakarta', 'Honor Luar Kota', 'STKB TRK Jakarta', 'STKB TRK Luar Kota', 'STKB OPS'];
          // console.log($('#rincian'));
          reloadButtonEdit(arrStatus1);
          ...
          buttonAjukan.addEventListener('click', function() {
            ...
            findLink.addEventListener("click", function() {
              ...
              findLink.href = "ajukanproses.php?id=" + id + "&ket=" + keterangan;
            })
          })
        })
        ...
        function reloadButtonEdit(arrStatus) {
          ...
          buttonAddQuestion.forEach(function(e, i) {
            ...
            e.addEventListener("click", function() {
              // console.log(i);
              buttonClicked = e;
              let numberClicked = i + 2;
              console.log(arrStatus);
              console.log($(`#status${numberClicked}`).text());
