    ...
    <table class="table table-striped table-bordered">
      ...
      <tbody>
        ...
        $sql = mysqli_query($koneksi, "SELECT
                                   *
                            FROM pengajuan
                            WHERE jenis='Rutin' AND status ='Disetujui' AND tahun ='2020'
                               OR jenis='Rutin' AND status ='Pending' AND tahun ='2020'
                               OR jenis='Rutin' AND status ='Disapprove' AND tahun ='2020'");
