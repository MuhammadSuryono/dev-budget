    ...
    <table class="table table-striped table-bordered">
      ...
      <tbody>
        ...
        $sql = mysqli_query($koneksi, "SELECT
                                   *
                            FROM pengajuan
                            WHERE jenis='Rutin' AND status ='Disetujui' AND tahun ='2018'
                               OR jenis='Rutin' AND status ='Pending' AND tahun ='2018'
                               OR jenis='Rutin' AND status ='Disapprove' AND tahun ='2018'");
        ...
        ?>
          ...
          ?>
            <tr>
              ...
              <td bgcolor="#ff99a1"><a href="view-finance.php?code=<?php echo $d['noid']; ?>"><i class="fas fa-eye" title="VIEW"></i></a></td>
              <td bgcolor="#ff99a1">
                <center>--</center>
              </td>
