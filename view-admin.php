...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="list-all.php">List</a></li>
        </ul>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-sm-4"><b>MM&nbsp;&nbsp; = <img src="images/pink.png" width="20px" height="15px"> Pengajuan BPU (Internal)</b></div>
    </div>
    ...
    <div class="row">
      <div class="col-sm-2"></div>
      <div class="col-sm-6"></div>
      <div class="col-sm-4"><b>O&nbsp;&nbsp; = <img src="images/orange.png" width="20px" height="15px"> Segera Di Tindak Lanjuti</b></div>
    </div>
        ...
        <div id="myTabContent" class="tab-content">
          ...
          <div role="tabpanel" class="tab-pane fade in active" id="budget" aria-labelledby="home-tab">
                        ...
                        if (mysqli_num_rows($liatbayar) == 0) {
                          ...
                          while ($bayar = mysqli_fetch_array($liatbayar)) {
                            ...
                            if (!in_array($waktu . $no . $bayar['term'], $arrCheck)) :
                              ...
                              echo "<td bgcolor=' $color '><div class='row'><div class='col-sm-6'>";
                              echo "</b></div></div>";
            ...
            <div class="row">
              ...
              <div class="col-xs-3">: <b><?php echo 'Rp. ' . number_format($row2['sum'], 0, '', ','); ?></font></b></div>
            </div>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-center">Permintaan Pencairan</h4>
            </div>
